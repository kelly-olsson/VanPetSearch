...
function About() {
    return (
        ...
        <p>Kelly Olsson is currently a student at the British Columbia Institute of Technology. 
          ...
          <p>She hopes that the site will help worried pet owners in Vancouver to find answers
            about their lost pets.</p>
          <p>If you would like to make suggestions to improve the site, please don't hesitate to
            contact her <a href="mailto:kolsson@gmail.com">here.</a></p>
      </div>
    )
}
